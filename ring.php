...
switch ($page) {
  case 1:
      $title = "PREMIUM RING ";
      $description = "Show off your charm with beautiful, high-end JULY rings that are full of charm. Are you ready to shine and attract all eyes with them!";
      $headerTitle = "RING";
  ...
  case 2:
      ...
      $description = "Adorn your hands with exquisitely beautiful JULY bracelets, adding a touch of luxury and elegance to your every step.";
      $headerTitle = "BRACELET";
      $carouselClass = "carousel1";
      $backgroundClass = "background2";
      break;
  case 3:
      $title = " PREMIUM NECKLACE";
      $description = "JULY necklace gives you perfect beauty, contributes to your own style and is a great highlight every time you appear.";
      $headerTitle = "NECKLACE";
      $carouselClass = "carousel1";
      $backgroundClass = "background3";
      break;
  case 4:
      $title = " PREMIUM HAIRPINS";
      $description = "Explore LiLi's collection of high-end hair accessories, bringing charm and prominence to your style. All meticulously designed, helping you become more perfect.";
      $headerTitle = "HAIRPINS";
      $carouselClass = "carousel1";
      $backgroundClass = "background4";
      break;
  case 5:
      $title = " PREMIUM ANKLET";
      $description = "Adorn your feet with beautiful, sophisticated JULY anklets, adding a touch of luxury and elegance to your every step.";
      $headerTitle = "ANKLET";
      $carouselClass = "carousel1";
      $backgroundClass = "background5";
      break;
  case 6:
      $title = " PREMIUM EARRING";
      $description = "Let's explore the collection of beautiful, high-end JULY earrings that bring charm and prominence to you. With meticulousness in every design line, you will become perfect!";
      $headerTitle = "EARRING";
      $carouselClass = "carousel1";
...
.carousel1 .background1 {
    background: url(./icon_wed/RING.jpg);
...
.carousel1 .background2 {
    background: url(./icon_wed/BRACELET.png);
    background-repeat: no-repeat !important;
    background-position: center !important;
    background-size: cover;
    -webkit-background-size: cover !important;
...
.carousel1 .background3 {
    background: url(./icon_wed/NECKLACE.png);
    background-repeat: no-repeat !important;
    background-position: center !important;
    background-size: cover;
    -webkit-background-size: cover !important;
...
.carousel1 .background4 {
    background: url(./icon_wed/HAIRPINS.png);
    background-repeat: no-repeat !important;
    background-position: center !important;
    background-size: cover;
    -webkit-background-size: cover !important;
...
.carousel1 .background5 {
    background: url(./icon_wed/ANKLET.png);
    background-repeat: no-repeat !important;
    background-position: center !important;
    background-size: cover;
    -webkit-background-size: cover !important;
...
.carousel1 .background6 {
    background: url(./icon_wed/EARRING.png);
    background-repeat: no-repeat !important;
    background-position: center !important;
    background-size: cover;
    -webkit-background-size: cover !important;
...
<!-- main -->
    <!-- mainheader -->
        <div class="carousel1" >
            <div class="<?php echo $backgroundClass; ?>" >
