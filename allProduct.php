...
.dropdown-list3-item.active {
  ...
  --shadow: rgba(0, 0, 0, 0.15) 0px 5px 15px 0px;
    ...
    background: url(./icon_wed/ALL.png);
    ...
    <!-- mainheader -->
        <div class="carousel1" >
            <div class="background">
                ...
                <div class="text-carousel1" style="
                    ">
                    <div class="text-carousel1-1" style="
                    ">
                    Search in all products
                    </div>
                    <div class="text-carousel1-2" style="
                    ">
                    Discover the diversity and richness of our unique collection, where you can find all the products that suit you best and make your fashion dreams come true! Immerse yourself in the space Shop attractively and embrace new style today!
                    </div>
                </div>
            </div>
        </div>
